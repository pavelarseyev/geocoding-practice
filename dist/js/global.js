...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_map__ = __webpack_require__(334);
...
Object(__WEBPACK_IMPORTED_MODULE_1__libs_binder__["a" /* binder */])({
    bounds: {
        "#map": [__WEBPACK_IMPORTED_MODULE_2__modules_map__["a" /* initMap */]]
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = initMap;
function initMap() {
    //here goes API key for google map
    var APIkey = "AIzaSyBK04nqVTOccf_UQ5airHZgru76FXnnUb4";

    var map = document.getElementById("map");
    var coords = [];
    var zoom = void 0;
    var addressesList = document.querySelector(".addresses-list");
    var bounds = void 0;
    ...
    $("form").submit(function (e) {
        ...
        //current ZIP-code
        var zip = input.val().length > 0 ? +input.val() : " ";
        ...
        $.ajax({
            ...
            success: function success(response) {
                ...
                if (response.status === "OK") {
                    ...
                    var radius = +zoom * 1609;

                    //create LatLng obj from center coordinates
                    var placeCoords = new google.maps.LatLng(center.lat, center.lng);
                    var distance = void 0;
                    ...
                    map.markers.forEach(function (item, i) {
                        ...
                        var markerPosition = item.getPosition();
